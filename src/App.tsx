...
function App() {
  ...
  const handleStartGame = (settings: GameSettings) => {
    const words = getUniqueWordsForTeams(settings.difficulty, settings.numberOfWords, settings.teams.length);
  ...
  const handlePlayAgain = () => {
    ...
    const wordsPerTeam = Math.floor(gameState.words.length / gameState.teams.length);
